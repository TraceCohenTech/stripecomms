    ...
    <section id="about" className="py-16 md:py-20 bg-stripe-navy text-white relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-10 lg:px-16">
        <div className="grid lg:grid-cols-[1fr,1.2fr] gap-10 lg:gap-16 items-start">
          ...
          >
            <span className="text-xs font-semibold tracking-[0.12em] uppercase text-stripe-cyan">
              Who Prepared This
            </span>
            <h2 className="font-editorial text-[1.75rem] md:text-[2rem] mt-2 tracking-[-0.01em] text-white">
              Trace Cohen
            </h2>
            <p className="text-white/90 text-[15px] mt-4 leading-relaxed">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                ...
                className="inline-flex items-center gap-1.5 text-sm font-medium text-stripe-cyan hover:text-white transition-colors duration-200"
              >
          ...
          >
            {credentials.map((item, i) => (
              <motion.div
                ...
                className="group p-5 rounded-xl bg-white/[0.05] border border-white/[0.08] hover:bg-white/[0.08] hover:border-white/[0.15] transition-all duration-300"
              >
